...
import { createApiV1Routes } from '../../../src/api/v1/routes';
import { createMockMatrixManager } from '../../../src/tests/mocks/matrixManager.mock';
import { createMockMetricsCollector } from '../../../src/tests/mocks/metricsCollector.mock';

// Mock the sub-route modules
jest.mock('../../../src/api/matrix', () => ({
...
describe('API V1 Routes', () => {
  ...
  describe('Module Integration', () => {
    ...
    it('should pass queueManager to task routes', () => {
      const { createTaskRoutes } = require('../../../src/api/task');
