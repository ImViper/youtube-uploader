import * as matrixExports from '../../../src/api/matrix/index';
import { MatrixController } from '../../../src/api/matrix/matrix.controller';
import { MatrixService } from '../../../src/api/matrix/matrix.service';
import { createMatrixRoutes } from '../../../src/api/matrix/matrix.routes';
