...
import { createDashboardRoutes, createSystemAlert, DashboardConfig } from './dashboard';
...
describe('Dashboard API', () => {
  ...
  describe('Alerts API', () => {
    describe('GET /api/dashboard/alerts', () => {
      ...
      it('should filter unacknowledged alerts', async () => {
        ...
        const response = await request(app)
          .get('/api/dashboard/alerts?unacknowledged=true')
          .expect(200);
      ...
      it('should respect limit parameter', async () => {
        const response = await request(app)
          .get('/api/dashboard/alerts?limit=2')
          .expect(200);
    ...
    describe('POST /api/dashboard/alerts/:id/acknowledge', () => {
      ...
      it('should return 404 for non-existent alert', async () => {
        const response = await request(app)
          .post('/api/dashboard/alerts/non-existent-id/acknowledge')
          .expect(404);
    ...
    describe('DELETE /api/dashboard/alerts/:id', () => {
      ...
      it('should return 404 for non-existent alert', async () => {
        const response = await request(app)
          .delete('/api/dashboard/alerts/non-existent-id')
          .expect(404);
    ...
    describe('POST /api/dashboard/alerts/batch/acknowledge', () => {
      it('should batch acknowledge multiple alerts', async () => {
        ...
        const response = await request(app)
          .post('/api/dashboard/alerts/batch/acknowledge')
          .send({ ids: alertIds })
          .expect(200);
    ...
    describe('POST /api/dashboard/alerts', () => {
      ...
      it('should limit alerts to 1000', async () => {
        ...
        const response = await request(app)
          .get('/api/dashboard/alerts?limit=2000')
          .expect(200);
  ...
  describe('Statistics APIs', () => {
    describe('GET /api/dashboard/stats/overview', () => {
    ...
    describe('GET /api/dashboard/stats/tasks', () => {
      it('should return task statistics with timeline', async () => {
        ...
        const response = await request(app)
          .get('/api/dashboard/stats/tasks?range=24h')
          .expect(200);
      ...
      it('should handle different time ranges', async () => {
        ...
        for (const range of ranges) {
          const response = await request(app)
            .get(`/api/dashboard/stats/tasks?range=${range}`)
            .expect(200);
    ...
    describe('GET /api/dashboard/stats/accounts', () => {
      it('should return account statistics with health distribution', async () => {
        ...
        const response = await request(app)
          .get('/api/dashboard/stats/accounts')
          .expect(200);
    ...
    describe('GET /api/dashboard/stats/performance', () => {
      it('should return performance metrics with timeline', async () => {
        ...
        const response = await request(app)
          .get('/api/dashboard/stats/performance?range=1h')
          .expect(200);
  ...
  describe('Chart APIs', () => {
    describe('GET /api/dashboard/charts/timeseries', () => {
      it('should return time series data for uploads metric', async () => {
        const response = await request(app)
          .get('/api/dashboard/charts/timeseries?metric=uploads&range=24h')
          .expect(200);
      ...
      it('should support different metrics', async () => {
        ...
        for (const metric of metrics) {
          const response = await request(app)
            .get(`/api/dashboard/charts/timeseries?metric=${metric}`)
            .expect(200);
      ...
      it('should auto-calculate interval based on range', async () => {
        ...
        for (const testCase of testCases) {
          const response = await request(app)
            .get(`/api/dashboard/charts/timeseries?range=${testCase.range}`)
            .expect(200);
      ...
      it('should use custom interval when provided', async () => {
        const response = await request(app)
          .get('/api/dashboard/charts/timeseries?interval=2')
          .expect(200);
    ...
    describe('GET /api/dashboard/charts/distribution', () => {
      it('should return distribution data for uploads', async () => {
        const response = await request(app)
          .get('/api/dashboard/charts/distribution?type=uploads')
          .expect(200);
      ...
      it('should support different distribution types', async () => {
        ...
        for (const type of types) {
          const response = await request(app)
            .get(`/api/dashboard/charts/distribution?type=${type}`)
            .expect(200);
    ...
    describe('GET /api/dashboard/charts/trends', () => {
      it('should return trend analysis for multiple metrics', async () => {
        const response = await request(app)
          .get('/api/dashboard/charts/trends?metrics=uploads,errors&range=7d')
          .expect(200);
      ...
      it('should calculate trend direction correctly', async () => {
        const response = await request(app)
          .get('/api/dashboard/charts/trends?metrics=test')
          .expect(200);
  ...
  describe('Helper Functions', () => {
    describe('createSystemAlert', () => {
      ...
      it('should maintain a maximum of 1000 alerts', () => {
        // Create 1005 alerts
